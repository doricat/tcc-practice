...
{
    public class CancellationTaskRabbitMqMessageSender : IDisposable
    {
        private readonly IConnection _connection;
        private readonly IModel _channel;

        public CancellationTaskRabbitMqMessageSender(ILogger<CancellationTaskRabbitMqMessageSender> logger,
        ...
        public ILogger<CancellationTaskRabbitMqMessageSender> Logger { get; }
